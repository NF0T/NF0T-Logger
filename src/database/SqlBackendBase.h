...
public:
    ...
    std::expected<void, QString> beginTransaction()    override;
    std::expected<void, QString> commitTransaction()   override;
    std::expected<void, QString> rollbackTransaction() override;
