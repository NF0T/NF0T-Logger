...
NF0T-Logger is under active development and currently at **v26.6.2**. The core logging, radio control, and QSL workflows are functional. Rough edges exist — contributions and bug reports are welcome.
